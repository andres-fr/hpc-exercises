...
// g++ -O3 -fopenmp -std=c++14 -Wall -Wextra /home/afr/SS17/hpc-praktikum/week7_openmp/1_bugs/bug3.cpp -o bug3 && ./bug3
...
int main() {
  ...
  // parallelized version: first calculate the sum, then the output
  sum = 0;
