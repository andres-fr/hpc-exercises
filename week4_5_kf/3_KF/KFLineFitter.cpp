...
// g++ -O3 -fno-tree-vectorize -g -msse -std=c++11 -I/opt/Vc/include -L/opt/Vc/lib  KFLineFitter.cpp -o test -lVc && ./test
...
#ifdef SIMDIZED
#include "../../libs/vectors/P4_F32vec4.h" // SSE instructions ( 4 floats per vector )
#endif
